<div>
    @if (request()->is('/'))
        <div class="grid object-center overflow-hidden h-screen content-center bg-black items-center"
             x-data="{ show: false }" x-init="show = true">
            <img src="https://wallpapers.com/images/hd/coffee-beans-with-leaves-xjack9rx9v60yf8l.jpg" class="w-fit h-auto" alt="Image">
            <h3 id="bean-brew" class="pr-8 text-white text-8xl border-r-[28px] font-poppins font-bold pl-12 border-white"
                x-show="show" x-transition:enter="transition-opacity duration-1500" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100">
                Bean <br> & <br> Brew
            </h3>
        </div>
        <style>

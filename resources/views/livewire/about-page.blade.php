<div>
    ...
    <section class="py-14 lg:py-24 relative z-0 ">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-9">
                ...
                <div class="lg:pl-[100px] flex items-center">
                    <div class="data w-full">
                        <h2
                            class="font-manrope font-bold text-4xl lg:text-5xl text-dark-brown mb-9 max-lg:text-center relative">
                            About
                            Us </h2>
                        <p class="font-normal text-xl leading-8 text-warm-brown max-lg:text-center max-w-2xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-9 ">
                ...
                <div class="lg:pr-24 flex items-center">
                    <div class="data w-full">
                        ...
                        <h2 class="font-manrope font-bold text-4xl lg:text-5xl text-dark-brown mb-9 max-lg:text-center">We
    ...
    <section class="py-20 ">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h2 class="font-manrope text-4xl text-center text-dark-brown font-bold mb-14">Our results in numbers</h2>
            <div class="flex flex-col gap-5 xl:gap-8 lg:flex-row lg:justify-between">
                <div
                    class="w-full max-lg:max-w-2xl mx-auto lg:mx-0 lg:w-1/3 bg-warm-brown p-6 rounded-2xl shadow-md shadow-gray-100">
                    <div class="flex gap-5">
                        <div class="font-manrope text-2xl font-bold text-dark-brown">
                            240%
                        </div>
                        <div class="flex-1">
                            <h4 class="text-xl text-white font-semibold mb-2">Company growth</h4>
                            <p class="text-xs text-light-gray leading-5">Company's remarkable growth journey as we
                ...
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-white font-semibold mb-2">Company growth</h4>
                            <p class="text-xs text-light-gray leading-5">Our very talented team members are the powerhouse
                ...
                <div
                    ...
                    <div class="flex gap-5">
                        ...
                        <div class="flex-1">
                            <h4 class="text-xl text-white font-semibold mb-2">Projects Completed</h4>
                            <p class="text-xs text-light-gray leading-5">We have accomplished more than 625 projects
